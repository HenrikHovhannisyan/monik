...
<div class="offline-container">
    <button id="backOnlineBtn">{{ __('index.back_online') }}</button>
    <canvas id="c"></canvas>
    ...
    <div class="menus">
        <div class="menu menu--main">
            ...
            <button type="button" class="play-normal-btn">{{ __('index.play_game') }}</button>
            <button type="button" class="play-casual-btn" style="display: none"></button>
        </div>
        <div class="menu menu--pause">
            <h1>{{ __('index.paused') }}</h1>
            <button type="button" class="resume-btn">{{ __('index.resume_game') }}</button>
            <button type="button" class="menu-btn--pause">{{ __('index.main_menu') }}</button>
        </div>
        <div class="menu menu--score">
            <h1>{{ __('index.game_over') }}</h1>
            <h2>{{ __('index.your_score') }}</h2>
            <div class="final-score-lbl"></div>
            <div class="high-score-lbl"></div>
            <button type="button" class="play-again-btn">{{ __('index.play_again') }}</button>
            <button type="button" class="menu-btn--score" style="display: none"></button>
        </div>
    </div>
</div>
...
<script>
    function checkOnlineStatus() {
        if (navigator.onLine) {
            document.getElementById('backOnlineBtn').style.display = 'block';
        } else {
            document.getElementById('backOnlineBtn').style.display = 'none';
        }
    }
