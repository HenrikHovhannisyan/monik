...
// Настройки минификации (удаление комментариев и прочее)
mix.options({
    terser: {
        extractComments: false, // удаляем все комментарии из JS
    },
    cssNano: {
        discardComments: { removeAll: true }, // удаляем все комментарии из CSS
    },
});

// Версионирование для автоматического кеширования
mix.version();
